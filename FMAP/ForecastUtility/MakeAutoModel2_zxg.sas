...
*/
	...
	*Solve 336 issue;
	%IF &Service ~= 336 %THEN %LET ThisLastDateOfAcutalData=&LastDateOfAcutalData;
	/*%ELSE; %LET ThisLastDateOfAcutalData=&LastDate;*/
	%ELSE; %LET ThisLastDateOfAcutalData=%SYSFUNC(INTNX(MONTH, &LastDateOfAcutalData, -2));
