...
/* ZXG ADDED ------------------------- 1/3/2018 ---------------*/
%if &FCycle= Feb2018 and
	(&category=1470 and &service=211)
%then %let ThisRatioMEAN=1;

/* ZXG ADDED ------------------------- 1/3/2018 ---------------*/
%if &FCycle= Feb2018 and
	(&category=1960 and &service=211)
%then %let ThisRatioMEAN=1;
...
%then %do;
   ...
   DATA FMAP.FmapRatio&category._&service;
	 ...
	 BaseFmap = 0.0671268;
	 FmapMOS = 0.0671268;
	 ProjectedFmap = 0.0671268;
	 if MOS>="01Apr2017"d then do;
